                        ...
                        {booksInRow.map((book, bookIndex) => (
                            bookIndex % 2 === 0
                              ? <div key={bookIndex} className="book-box">
                                    <img src={`/SarthakBookstoreReact/${book.image_path}`} width="90%" height="100%" className={bookIndex % 2 === 0 ? "home-fea-top-img" : "home-fea-bottom-img" } alt='book_image'></img>
                                ...
                                <div key={bookIndex} className="book-box">
                                    <p className="home-fea-title">{book.book_name}</p>
                                    <p className="home-fea-sub">{book.author}</p>
                                    <img src={`/SarthakBookstoreReact/${book.image_path}`} width="90%" height="100%" className="home-fea-bottom-img" alt='book_image'></img>
                                </div>
                        ))}
                    </div>
                ))}
